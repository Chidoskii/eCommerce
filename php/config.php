...
ini_set("error_log", "/home/stu/cokpara/php_errors.log");
...
function get_mysqli_connection() {
    ...
    if (!isset($connection)) {
        $connection = mysqli_connect(
            ...
            'cokpara', // the MariaDB username
            'Dan!4Bvuky', // the MariaDB username's password
            'cokpara' // the MariaDB database name
...
function get_pdo_connection() {
    ...
    if (!isset($conn)) {
        try {
            ...
            $conn = new PDO(
                "mysql:host=localhost;dbname=cokpara",  // change dbname
                "cokpara",                          // change username
                "Dan!4Bvuky",                      // change password
                $options);
        }
